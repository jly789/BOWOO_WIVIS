...
namespace DPS_B2B
{
    public partial class LoginForm : lib.Common.Management.BaseForm
    {
        ...
        {
            bowooRedConfirmBox.Show("종료 하시겠습니까?");
        ...
        public void LoginProcess()
        {
            ...
            if (loginResult)
            {
                ...
                Form frm = new DPS_B2B.MainForm();
                frm.Owner = this;
                frm.Show();

                bowooMessageBox.Show("해당 어플리케이션의 최적화된 해상도는 1280*720입니다.");
                ...
                if (BaseEntity.sessWrkStatus) {
                    ...
                    try
                    {
                        ...
                        if (System.Diagnostics.Debugger.IsAttached)
                        {
                            ...
                            ExePath = string.Format(@"{0}\Dps_DashBoard\bin\Release\Dps_DashBoard.exe", SorterFullPath);
                        }
                        else
                        {
                            SorterFullPath = Application.StartupPath;
                            ExePath = string.Format(@"{0}\Dps_DashBoard.exe", SorterFullPath);
                        }
        ...
        protected BaseEntity.enmLoginResult CheckUser(string ID,string PW) {
            try
            {
                if (DBUtil.Conn.State.ToString().Equals("Closed"))
                {
                    ...
                    DataSet dsUsrInfo = DBUtil.ExecuteDataSet("DBO.SP_CHK_LOGIN",param,CommandType.StoredProcedure);
                    ...
                    DataSet dsWrkStatusInfoYN = DBUtil.ExecuteDataSet("DBO.SP_CODE", paramStatusInfoYN, CommandType.StoredProcedure);
                    ...
                    DataSet dsWrkStatusInfoUseMonitors = DBUtil.ExecuteDataSet("DBO.SP_CODE", paramUseMornitors, CommandType.StoredProcedure);
        ...
        private void radTextBox_Leave(object sender, EventArgs e)
        {
            ...
            if (SelectBox.Name == "radTextBoxID")
            {
                ...
                ChangeBackColor(this.radTextBoxPW, System.Drawing.Color.BlanchedAlmond);
            }
            else {
                ChangeBackColor(this.radTextBoxPW, System.Drawing.Color.White);
                ChangeBackColor(this.radTextBoxID, System.Drawing.Color.BlanchedAlmond);
            }
        }
        ...
        {
            ChangeBackColor((sender as RadTextBox), System.Drawing.Color.BlanchedAlmond);
        }
